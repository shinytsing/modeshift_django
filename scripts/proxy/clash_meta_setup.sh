...
echo "下载Clash Meta..."
# 使用Clash Meta，更活跃维护
wget -O clash.gz "https://github.com/MetaCubeX/Clash.Meta/releases/download/v1.18.0/clash.meta-linux-amd64-v1.18.0.gz"
gunzip clash.gz
mv clash.meta-linux-amd64-v1.18.0 clash
chmod +x clash
...
echo ""
echo "=== 设置完成 ==="
echo "Clash Meta代理已成功安装在服务器 $SERVER_IP 上！"
echo ""
echo "现在你可以："
