...
echo "下载Clash (使用最新版本)..."
# 获取最新版本
LATEST_VERSION=$(curl -s https://api.github.com/repos/Dreamacro/clash/releases/latest | grep "tag_name" | cut -d '"' -f 4)
echo "最新版本: $LATEST_VERSION"

# 下载最新版本
wget -O clash.gz "https://github.com/Dreamacro/clash/releases/download/${LATEST_VERSION}/clash-linux-amd64-${LATEST_VERSION}.gz"
gunzip clash.gz
chmod +x clash
