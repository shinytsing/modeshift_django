...
# Django's built-in User model still requires a unique username.  The signup form remains
# email-only, while allauth derives a unique username from the submitted email.
