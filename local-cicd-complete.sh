...
# ModeShift Django 本地CI/CD完整测试脚本
# 与GitHub Actions完全相同的测试流程
# =============================================
...
# 主函数
main() {
    log_info "开始ModeShift Django本地CI/CD完整测试..."
    log_info "测试时间: $(date)"
    ...
    log_success "🎉 本地CI/CD完整测试通过！"
    log_info "所有测试阶段都成功完成"
    log_info "代码已准备好推送到GitHub进行部署"
}

# 错误处理
trap 'log_error "测试过程中发生错误，退出码: $?"; cleanup_test_environment; exit 1' ERR
